...
export const Footer = () => (
  <footer className="py-3 border-top  footer_container" id="footer_contain">
    <div className="row footer_row ">
      <div className="col-6 col-lg-2 footer_col mt-3">
        <div className="footer_logo mb-2">
          <img
            type="button"
            className="btn btn-danger footer_logo_btn"
            src={logo}
      ...
      <div className="col-6 col-lg-2 footer_col mt-3">
        <div className="footer_store mb-2 ">
          <button
            type="button"
            className="btn btn-danger footer_store_btn mb-4 "
          >
            <div className="footer_appstore ">
              <i className="fab fa-apple me-2"></i>
              <p className="footer_appstore_text mt-3">
                Download on the
                <br />
                <strong className="footer_appstore_text1 mt-3">
                  App Store
                </strong>
              </p>
            </div>
          ...
          >
            <div className="footer_appstore">
              ...
              <p className="footer_google-play_text mt-3">
                Get it on <br />
                <strong className="footer_google-play_text1 mt-3">
                  Google Play
                </strong>
              </p>
            </div>
      ...
      <div className="col-4 col-lg-2 footer_col  ">
        <div className="footer_infotext_container ">
          ...
          <p className="footer_infosubtext">
            {" "}
            About us <br /> Contact <br />
            Promotions
            <br /> DishDash Prime
          </p>
        </div>
      ...
      <div className="col-4 col-lg-2 footer_col  ">
        <div className="footer_infotext_container ">
          ...
          <p className="footer_infosubtext">
            {" "}
            Terms and conditions <br /> Privacy policy <br />
            Cookies policy
            <br /> Compliance
          </p>
        </div>
