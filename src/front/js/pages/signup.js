    ...
    <div className="container-fluid text-center p-5 signup_page_container">
      <div className="row signup_all">
        ...
        <div className="signup_form_container col-sm-8 col-12  ">
          ...
          >
            <div className="mb-3">
              <label htmlFor="userEmail" className="form-label signup_label">
                Email address
              </label>
              <input
                type="email"
            ...
            <div className="mb-3">
              <label htmlFor="userPassword" className="form-label signup_label">
                Password
              </label>
              <input
                type="password"
              ...
              <div id="emailHelp" class="form-text">
                Must have at leats 8 characters, a number and an upper case
                letter
              </div>
            </div>
            <div className="mb-3">
              <label
                htmlFor="userPassword2"
                className="form-label signup_label"
              >
                Confirm Password
              </label>
              <input
            ...
            <div className="row my-3">
              ...
              <div className="col-12 col-sm-6 signup_checkbox_container">
                ...
                />
                <label className="form-check-label" htmlFor="companycheckbox">
                  I'm a company
                </label>
              </div>
            </div>
